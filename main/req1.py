...
def registrar_cliente():
    ...
    while True:
        try:
            cedula_str = input("Ingrese la cédula del cliente [Formato = xxx-xxxxx-xxxx, 13 digitos númericos y 1 letra al final]: ").strip()
            if not cedula_str:
                print("No puede haber una entrada de datos vacía")
